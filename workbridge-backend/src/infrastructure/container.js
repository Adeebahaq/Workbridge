...
// Nothing outside this file imports Mongo models or adapters directly.
...
module.exports = {
  ...
  sendJobRequestUseCase: new SendJobRequestUseCase(jobRepo),
  cancelJobUseCase:      new CancelJobUseCase(jobRepo),
  confirmJobUseCase:     new ConfirmJobUseCase(jobRepo),
  rateWorkerUseCase:     new RateWorkerUseCase(jobRepo, ratingRepo, workerRepo),
  // admin
  ...
  // repositories (passed directly to controllers that don't need a use case)
  serviceTypeRepo,
};