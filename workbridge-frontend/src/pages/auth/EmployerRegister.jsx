...
export default function EmployerRegister() {
  ...
  const verifyOtp = async (e) => {
    ...
    try {
      ...
      navigate("/login", { state: { message: t("employer_register.verified_message"), prefillPhone: form.phone, prefillPassword: form.password } });
          ...
          {step === 0 && (
            <form onSubmit={handleSubmit} className="space-y-4" autoComplete="off">
              ...
              <div>
                ...
                <input
                  className={`${inputCls} ${fieldErrors.phone ? "border-red-400 focus:border-red-400 focus:ring-red-400/20" : ""}`}
              ...
              <div>
                ...
                <input
                  className={`${inputCls} ${fieldErrors.password ? "border-red-400 focus:border-red-400 focus:ring-red-400/20" : ""}`}
              ...
              <div>
                ...
                <input
                  className={`${inputCls} ${fieldErrors.confirmPassword ? "border-red-400 focus:border-red-400 focus:ring-red-400/20" : ""}`}
