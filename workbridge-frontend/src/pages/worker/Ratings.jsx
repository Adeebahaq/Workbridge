      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-6">
        <div className="flex items-center gap-8">
          ...
          <div className="text-center shrink-0">
            <p className="text-6xl font-black text-slate-800">{Number(averageRating).toFixed(1)}</p>
        ...
        <div className="grid grid-cols-3 gap-4 mt-6 pt-4 border-t border-slate-100">
          {[
            ...
            { icon: Award,     color: "text-indigo-500",label: "5-Star Ratings",value: dist[0].count                   },
